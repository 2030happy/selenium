...
from keras.layers import Dense, Layer,Lambda, Dropout, Activation, Input, Merge, Multiply, Bidirectional, LSTM
...
model.fit([tr_head,tr_body],Y_train, nb_epoch = 3,verbose=2)
